"""
Django settings for smart_parking_solut_48379 project.
...
ROOT_URLCONF = 'smart_parking_solut_48379.urls'
...
WSGI_APPLICATION = 'smart_parking_solut_48379.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Smart parking solution Support <support@smart-parking-solut-48379.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "smart_parking_solut_48379 API",
    "DESCRIPTION": "API documentation for smart_parking_solut_48379 App",
    "VERSION": "v1",
}
